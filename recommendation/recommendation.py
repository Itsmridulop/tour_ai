...
class TourRecommender:
    ...
    def recommend(self, tour_name: str):
        ...
        return self.df[['name', 'imageCover', 'startLocation_description', 'startDates', 'ratingsAverage', 'ratingsQuantity', 'maxGroupSize']].iloc[tour_indices].to_dict(orient='records')
